...
class PhysicalParams:
    def __init__(self):
        ...
        self.halfMoonHeight = self.cryoFloorTo40K_InsertBottom + self.insert_40KThickness \
                              -(self.topOf300KFlange_toTopOf40KFlange
                                - (self.bottomWallShellThickness + (self.collar_height * self.inch_to_mm)))
        ...
        self.fortyK_heatPlate_extensionDistance = 300.0
